...
const Comments = (props) => {
  ...
  const loadReplies = React.useCallback(async () => {
    axios
      .get("/api/comments/replies/" + props.comments.CommentID)
      .then((res) => {
        setReplies(res.data);
      });
  }, [props.comments]);
  ...
  const loadReplyCount = React.useCallback(async () => {
    axios
      .get("/api/comments/replycount/" + props.comments.CommentID)
      .then((res) => {
      ...
      <div className="comment-box shadow p-3 mb-3 bg-white rounded ">
        <div className="row">
          ...
          <div className="col-lg-2">
            {props.comments.InstructorID === props.instructor.InstructorID && (
              <React.Fragment>
                <DeleteComment
