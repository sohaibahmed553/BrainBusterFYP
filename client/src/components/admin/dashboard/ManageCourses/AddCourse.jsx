...
const AddCourse = (props) => {
  ...
  const onFinish = (values) => {
    if (
      ...
      axios.get("/api/courses/codes/" + code).then((res) => {
        ...
        if (unique) {
          ...
          fd.append(
            "file",
            file,
            file.type === "image/jpeg" ? code + ".jpg" : code + ".png"
          );
  ...
  return (
    <React.Fragment>
      ...
      >
        <h5 className="d-flex justify-content-center">Add a new Course</h5>
        <br />
        <br />
              ...
              rules={[
                {
                  required: true,
                  max: 7,
                  message: "Please input course code of maximum 7 characters",
                },
              ]}
            >
              <Input />
