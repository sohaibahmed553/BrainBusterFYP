		...
		if (person === "0") {
			axios
				...
				.then((res) => {
					...
					dispatch(getRegCourses(stdid));
					console.log(regCourses);
					const courseid = regCourses.length ? regCourses[0].CourseID : null;
					props.history.push(`/student?courseid=${courseid}`);
				})
				.catch((err) => {
	...
	return (
		<div className="outer d-flex align-items-center justify-content-center">
			...
			<Form
				...
				onFinish={onFinish}
			>
				<h5 className="d-flex justify-content-center">Sign In to BrainBuster</h5>
				<br />
				<Form.Item
					name="UserName"
					rules={[
